...
<div class="table-container">
    <div class="table-header">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            {{-- Search --}}
            <form method="GET" action="{{ route('employes.index') }}" class="flex items-center gap-3">
                        ...
                        <tr>
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-sm">{{ $employe->nom_complet }}</p>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('employes.show', $employe) }}" class="btn-icon" style="color: var(--color-secondary); background-color: var(--color-secondary-light);" title="Voir">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
